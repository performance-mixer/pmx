...
public:
       Button(LedState led_state, const launchpad_color &color,
              ButtonType button_type, MidiType midi_type,
              std::uint8_t midi_value)
              : _led_state(led_state), _color(color), _button_type(button_type),
                _midi_type(midi_type), _midi_index(midi_value) {}

       void add_launchpad_updates_to_sequence(spa_pod_builder &builder) const;
...
private:
       ...
       MidiType _midi_type;
       std::uint8_t _midi_index;

       void add_control_change_update_to_sequence(
              spa_pod_builder &builder) const;

       void add_note_update_to_sequence(spa_pod_builder &builder) const;

       [[nodiscard]] std::tuple<unsigned int, unsigned int> determine_channel_and_color() const;
};
...
public:
       ...
       [[nodiscard]] const Button &button(size_t row, size_t column) const {
              return _buttons[row * 9 + column];
       }
...
private:
       std::array<Button, 81> _buttons{
              ...
              Button(LedState::on, colors::amber, ButtonType::standard,
                     MidiType::note, 81),
              Button(LedState::on, colors::amber, ButtonType::standard,
                     MidiType::note, 82),
              Button(LedState::on, colors::amber, ButtonType::standard,
              ...
              Button(LedState::off, colors::black, ButtonType::standard,
                     MidiType::note, 71),
              Button(LedState::off, colors::black, ButtonType::standard,
                     MidiType::note, 72),
              Button(LedState::off, colors::black, ButtonType::standard,
              ...
              Button(LedState::off, colors::black, ButtonType::standard,
                     MidiType::note, 78),
              Button(LedState::on, colors::aqua_blue,
                     ButtonType::rightmost_column, MidiType::control_change,
                     79),
              Button(LedState::off, colors::black, ButtonType::standard,
                     MidiType::note, 61),
              Button(LedState::off, colors::black, ButtonType::standard,
