...
std::shared_ptr<parameters::parameter> parameters::none =
    std::make_shared<parameters::parameter>(0, "none", "none", 0.0, 0.0, "NA");
...
std::shared_ptr<parameters::parameter> parameters::saturator_blend =
    std::make_shared<parameters::parameter>(3, "blend", "Saturator", -10, 1,
                                            "SAT");
...
std::shared_ptr<parameters::parameter> parameters::compressor_ratio =
    std::make_shared<parameters::parameter>(6, "ratio", "Compressor", 1.0, 20.0,
                                            "CMP");
