...
class ParseButtonEvents : public testing::TestWithParam<std::tuple<
    uint8_t, uint8_t, uint8_t>> {};

TEST_P(ParseButtonEvents, ParseMidiNoteOnV2) {
...
INSTANTIATE_TEST_SUITE_P(SessionMode, ParseButtonEvents,
                         testing::Values( std::make_tuple(91, 0, 0), std::
                           ...
                           std::make_tuple(81, 1, 0), std::make_tuple(82, 1, 1),
                           std::make_tuple(83, 1, 2), std::make_tuple(84, 1, 3),
                           std::make_tuple(85, 1, 4), std::make_tuple(86, 1, 5),
                           std::make_tuple(87, 1, 6), std::make_tuple(88, 1, 7),
                           std::make_tuple(89, 1, 8), std::make_tuple(71, 2, 0),
                           std::make_tuple(72, 2, 1), std::make_tuple(73, 2, 2),
                           std::make_tuple(74, 2, 3), std::make_tuple(75, 2, 4),
                           std::make_tuple(76, 2, 5), std::make_tuple(77, 2, 6),
                           std::make_tuple(78, 2, 7), std::make_tuple(79, 2, 8),
                           std::make_tuple(61, 3, 0), std::make_tuple(62, 3, 1),
                           std::make_tuple(63, 3, 2), std::make_tuple(64, 3, 3),
                           std::make_tuple(65, 3, 4), std::make_tuple(66, 3, 5),
                           std::make_tuple(67, 3, 6), std::make_tuple(68, 3, 7),
                           std::make_tuple(69, 3, 8), std::make_tuple(51, 4, 0),
                           std::make_tuple(52, 4, 1), std::make_tuple(53, 4, 2),
                           std::make_tuple(54, 4, 3), std::make_tuple(55, 4, 4),
                           std::make_tuple(56, 4, 5), std::make_tuple(57, 4, 6),
                           std::make_tuple(58, 4, 7), std::make_tuple(59, 4, 8),
                           std::make_tuple(41, 5, 0), std::make_tuple(42, 5, 1),
                           std::make_tuple(43, 5, 2), std::make_tuple(44, 5, 3),
                           std::make_tuple(45, 5, 4), std::make_tuple(46, 5, 5),
                           std::make_tuple(47, 5, 6), std::make_tuple(48, 5, 7),
                           std::make_tuple(49, 5, 8), std::make_tuple(31, 6, 0),
                           std::make_tuple(32, 6, 1), std::make_tuple(33, 6, 2),
                           std::make_tuple(34, 6, 3), std::make_tuple(35, 6, 4),
                           std::make_tuple(36, 6, 5), std::make_tuple(37, 6, 6),
                           std::make_tuple(38, 6, 7), std::make_tuple(39, 6, 8),
                           std::make_tuple(21, 7, 0), std::make_tuple(22, 7, 1),
                           std::make_tuple(23, 7, 2), std::make_tuple(24, 7, 3),
                           std::make_tuple(25, 7, 4), std::make_tuple(26, 7, 5),
                           std::make_tuple(27, 7, 6), std::make_tuple(28, 7, 7),
                           std::make_tuple(29, 7, 8), std::make_tuple(11, 8, 0),
                           std::make_tuple(12, 8, 1), std::make_tuple(13, 8, 2),
                           std::make_tuple(14, 8, 3), std::make_tuple(15, 8, 4),
                           std::make_tuple(16, 8, 5), std::make_tuple(17, 8, 6),
                           std::make_tuple(18, 8, 7), std::make_tuple(19, 8, 8)
                         ));
